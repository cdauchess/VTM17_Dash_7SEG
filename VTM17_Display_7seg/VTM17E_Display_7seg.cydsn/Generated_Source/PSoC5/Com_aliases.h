...
#define Com_4			(Com__4__PC)
#define Com_4_INTR	((uint16)((uint16)0x0001u << Com__4__SHIFT))

#define Com_INTR_ALL	 ((uint16)(Com_0_INTR| Com_1_INTR| Com_2_INTR| Com_3_INTR| Com_4_INTR))
