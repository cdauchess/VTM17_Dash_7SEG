...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgInverter1
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgInverter1(void) 
    {
        /* `#START MESSAGE_Inverter1_RECEIVED` */
	RXFlag0 = 1; //Set Flag
	RXDLC = CAN_GET_DLC(0);
	for(bIndex = 0;bIndex<RXDLC;bIndex++)
	{
        ...
        #ifdef CAN_RECEIVE_MSG_Inverter1_CALLBACK
            CAN_ReceiveMsg_Inverter1_Callback();
        #endif /* CAN_RECEIVE_MSG_Inverter1_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_ReceiveMsgInverter2
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgInverter2(void) 
    {
        /* `#START MESSAGE_Inverter2_RECEIVED` */
	RXFlag1 = 1; //Set Flag
	RXDLC = CAN_GET_DLC(1);
	for(bIndex = 0;bIndex<RXDLC;bIndex++)
	{
        ...
        #ifdef CAN_RECEIVE_MSG_Inverter2_CALLBACK
            CAN_ReceiveMsg_Inverter2_Callback();
        #endif /* CAN_RECEIVE_MSG_Inverter2_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgVMC30_1
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgVMC30_1(void) 
    {
        /* `#START MESSAGE_VMC30_1_RECEIVED` */
	RXFlag2 = 1; //Set Flag
	RXDLC = CAN_GET_DLC(2);
	for(bIndex = 0;bIndex<RXDLC;bIndex++)
	{
        ...
        #ifdef CAN_RECEIVE_MSG_VMC30_1_CALLBACK
            CAN_ReceiveMsg_VMC30_1_Callback();
        #endif /* CAN_RECEIVE_MSG_VMC30_1_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgVMC30_2
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgVMC30_2(void) 
    {
        /* `#START MESSAGE_VMC30_2_RECEIVED` */
	RXFlag3 = 1; //Set Flag
	RXDLC = CAN_GET_DLC(3);
	for(bIndex = 0;bIndex<RXDLC;bIndex++)
	{
        ...
        #ifdef CAN_RECEIVE_MSG_VMC30_2_CALLBACK
            CAN_ReceiveMsg_VMC30_2_Callback();
        #endif /* CAN_RECEIVE_MSG_VMC30_2_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgBMS1
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgBMS1(void) 
    {
        /* `#START MESSAGE_BMS1_RECEIVED` */
	RXFlag4 = 1; //Set Flag
	RXDLC = CAN_GET_DLC(4);
	for(bIndex = 0;bIndex<RXDLC;bIndex++)
	{
        ...
        #ifdef CAN_RECEIVE_MSG_BMS1_CALLBACK
            CAN_ReceiveMsg_BMS1_Callback();
        #endif /* CAN_RECEIVE_MSG_BMS1_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgVMC30_3
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgVMC30_3(void) 
    {
        /* `#START MESSAGE_VMC30_3_RECEIVED` */
	RXFlag5 = 1; //Set Flag
	RXDLC = CAN_GET_DLC(5);
	for(bIndex = 0;bIndex<RXDLC;bIndex++)
	{
        ...
        #ifdef CAN_RECEIVE_MSG_VMC30_3_CALLBACK
            CAN_ReceiveMsg_VMC30_3_Callback();
        #endif /* CAN_RECEIVE_MSG_VMC30_3_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgBMS2
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgBMS2(void) 
    {
        /* `#START MESSAGE_BMS2_RECEIVED` */
	RXFlag6 = 1; //Set Flag
	RXDLC = CAN_GET_DLC(5);
	for(bIndex = 0;bIndex<RXDLC;bIndex++)
	{
		RXMessage6[bIndex] = CAN_RX_DATA_BYTE(5,bIndex);
	}
        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_BMS2_CALLBACK
            CAN_ReceiveMsg_BMS2_Callback();
        #endif /* CAN_RECEIVE_MSG_BMS2_CALLBACK */
...
`#start MESSAGE_6_RECEIVED` -- section removed from template
    	RXFlag6 = 1; //Set Flag
    	RXDLC = CAN_GET_DLC(6);
    	for(bIndex = 0;bIndex<RXDLC;bIndex++)
    	{
    		RXMessage6[bIndex] = CAN_RX_DATA_BYTE(6,bIndex);
    	}
`#end`

#endif /* end disabled code */
#if 0 /* begin disabled code */
`#start MESSAGE_RPM_RECEIVED` -- section removed from template
            RXFlag0 = 1; //Set flag
        RXDLC = CAN_GET_DLC(0);
        for(bIndex = 0;bIndex<RXDLC;bIndex++)
        {
...
#endif /* end disabled code */
#if 0 /* begin disabled code */
`#start MESSAGE_ECT_RECEIVED` -- section removed from template
            RXFlag1 = 1; //Set flag
        RXDLC = CAN_GET_DLC(1);
        for(bIndex = 0;bIndex<RXDLC;bIndex++)
        {
...
#endif /* end disabled code */
#if 0 /* begin disabled code */
`#start MESSAGE_EGT_RECEIVED` -- section removed from template
            RXFlag2 = 1; //Set flag
        RXDLC = CAN_GET_DLC(2);
        for(bIndex = 0;bIndex<RXDLC;bIndex++)
        {
...
#endif /* end disabled code */
#if 0 /* begin disabled code */
`#start MESSAGE_BP_RECEIVED` -- section removed from template
            RXFlag3 = 1; //Set flag
        RXDLC = CAN_GET_DLC(3);
        for(bIndex = 0;bIndex<RXDLC;bIndex++)
        {
...
#endif /* end disabled code */
#if 0 /* begin disabled code */
`#start MESSAGE_SPD_RECEIVED` -- section removed from template
            RXFlag4 = 1; //Set flag
        RXDLC = CAN_GET_DLC(4);
        for(bIndex = 0;bIndex<RXDLC;bIndex++)
        {
...
#endif /* end disabled code */
#if 0 /* begin disabled code */
`#start MESSAGE_OT_RECEIVED` -- section removed from template
            RXFlag5 = 1; //Set flag
        RXDLC = CAN_GET_DLC(5);
        for(bIndex = 0;bIndex<RXDLC;bIndex++)
        {
