// ======================================================================
// VTM17E_Display_7seg.v generated from TopDesign.cysch
// 04/04/2017 at 22:38
...
module top ;
    ...
    cy_annotation_universal_v1_0 Page_Switch (
        .connect({
            Net_109,
            Net_110
        })
    );
    defparam Page_Switch.comp_name = "SwitchSPST_v1_0";
    defparam Page_Switch.port_names = "T1, T2";
    defparam Page_Switch.width = 2;

	wire [0:0] tmpOE__PageSwitch_net;
	wire [0:0] tmpIO_0__PageSwitch_net;
	wire [0:0] tmpINTERRUPT_0__PageSwitch_net;
	electrical [0:0] tmpSIOVREF__PageSwitch_net;
	...
	assign tmpOE__PageSwitch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
