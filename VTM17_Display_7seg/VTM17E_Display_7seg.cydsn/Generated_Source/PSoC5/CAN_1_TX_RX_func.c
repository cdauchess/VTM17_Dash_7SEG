...
void CAN_1_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgRPM
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgRPM(void) 
    {
        /* `#START MESSAGE_RPM_RECEIVED` */

        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_RPM_CALLBACK
            CAN_1_ReceiveMsg_RPM_Callback();
        #endif /* CAN_1_RECEIVE_MSG_RPM_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_1_ReceiveMsgECT
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgECT(void) 
    {
        /* `#START MESSAGE_ECT_RECEIVED` */

        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_ECT_CALLBACK
            CAN_1_ReceiveMsg_ECT_Callback();
        #endif /* CAN_1_RECEIVE_MSG_ECT_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgEGT
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgEGT(void) 
    {
        /* `#START MESSAGE_EGT_RECEIVED` */

        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_EGT_CALLBACK
            CAN_1_ReceiveMsg_EGT_Callback();
        #endif /* CAN_1_RECEIVE_MSG_EGT_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgBP
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgBP(void) 
    {
        /* `#START MESSAGE_BP_RECEIVED` */

        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_BP_CALLBACK
            CAN_1_ReceiveMsg_BP_Callback();
        #endif /* CAN_1_RECEIVE_MSG_BP_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgSPD
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgSPD(void) 
    {
        /* `#START MESSAGE_SPD_RECEIVED` */

        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_SPD_CALLBACK
            CAN_1_ReceiveMsg_SPD_Callback();
        #endif /* CAN_1_RECEIVE_MSG_SPD_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgOT
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgOT(void) 
    {
        /* `#START MESSAGE_OT_RECEIVED` */

        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_OT_CALLBACK
            CAN_1_ReceiveMsg_OT_Callback();
        #endif /* CAN_1_RECEIVE_MSG_OT_CALLBACK */
