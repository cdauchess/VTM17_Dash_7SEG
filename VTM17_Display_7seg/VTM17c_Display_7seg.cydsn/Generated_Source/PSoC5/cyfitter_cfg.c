...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480003E4u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000408u)

/* PHUB_CFGMEM4 Address: CYREG_PHUB_CFGMEM4_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM4_VAL ((const uint8 CYFAR *)0x4800040Cu)
