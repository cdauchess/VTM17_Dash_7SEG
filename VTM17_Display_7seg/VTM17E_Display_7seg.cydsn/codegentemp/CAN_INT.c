            ...
            if ((CY_GET_REG16((reg16 *) &CAN_BUF_SR_REG.byte[0u]) & shift) != 0u)
            {
                if ((CAN_RX[mailboxNumber].rxcmd.byte[0u] & CAN_RX_INT_ENABLE_MASK) != 0u)
                {
                    if ((CAN_RX_MAILBOX_TYPE & shift) != 0u)
                    {
                        ...
                        {
                            case 0u : CAN_ReceiveMsgInverter1();
                            break;
                            case 1u : CAN_ReceiveMsgInverter2();
                            break;
                            case 2u : CAN_ReceiveMsgVMC30_1();
                            break;
                            case 3u : CAN_ReceiveMsgVMC30_2();
                            break;
                            case 4u : CAN_ReceiveMsgBMS1();
                            break;
                            case 5u : CAN_ReceiveMsgVMC30_3();
                            break;
                            case 6u : CAN_ReceiveMsgBMS2();
                            break;
                            default:
                            break;
                        }
