...
#define CAN_RX_MAILBOX_RPM             (0u)
#define CAN_RX_MAILBOX_ECT             (1u)
#define CAN_RX_MAILBOX_EGT             (2u)
#define CAN_RX_MAILBOX_BP              (3u)
#define CAN_RX_MAILBOX_SPD             (4u)
#define CAN_RX_MAILBOX_OT              (5u)
